...
return [
    ...
    */
    ...
    // 学习费用 = 该值 × 解锁等级 × skill_points_cost。升级不再发放技能点。
    'skill_learn_copper_per_level' => 80,
    ...
    */
    'gem_drop' => [
        // 装备没掉时再判。原先 5%，价格提高 10 倍后降到 0.5%。
        'chance' => 0.005,
    ],

    // 宝石售价 = 属性估价 × 该倍数。商店买价仍是售价的 2 倍。
    'gem_price_multiplier' => 10,
